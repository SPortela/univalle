			...
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form method="post" action="../descarga_xls.php" style="position: relative; top:0px;">
							<input type="text" name="txtFecha1" id="txtFecha1" value="" class="date" placeholder="AAAA-MM-DD" />
							<input type="text" name="txtFecha2" id="txtFecha2" value="" class="date" placeholder="AAAA-MM-DD" />
							<input type="hidden" name="CedulaAgente" value="<?php echo $cedula_agente; ?>">
							<input type="hidden" name="Perfil" value="<?php echo $perfil_usr; ?>">
							<button type="submit" class="btn btn-info">Descargar</button>
							<a href="#" title="Contar" class="btn btn-info"><?php echo $title; ?>: <?php $rows = $contact->Count($whereC);
