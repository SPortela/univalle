    ...
    class BaseAntiguos{
        ...
        */
        public function selectAll($where = ""){
             /** Realiza el query */
                $sql = "SELECT Id, Registro_Id, SeMatriculara, FechaMatricula, PorqueNoMatricula, ActivoCorreoIns, EstaSatisfecho, PorqueInsatisfecho,
						Trabaja, Retirar, Comentarios, ResultadoFinal, NoContacta,
                 Status, Tipo, Created_date
        ...
        */
        public function pagerCount($page){
            $sql = "SELECT  count(*) as num FROM estados Where Status = 1";
            $result = $this->db->ejecutar($sql);
