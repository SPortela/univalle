	...
	class usuario{
		...
		*/
		public function selectAll($where = ""){
			/** Realiza el query */
			$sql = "SELECT Us.Id, Us.Nombre, Us.Cedula, Us.Sede, Us.Direccion, Us.Disponible, Us.Telefono, Us.TipoAsignacion, Us.Email, Us.Perfil, Us.Usuario, Us.Foto, Us.Status, Us.Created_at
							FROM " . $this->table . " Us
							" . $where;
			//echo $sql;
		...
		*/
		public function UltimoId(){
		    $sql = " SELECT Us.Id, Us.Cedula, Us.Nombre FROM ". $this->table. " Us ORDER BY Id DESC LIMIT 1";
		    //echo $sql;
		    $result = $this->db->ejecutar($sql);
		    if($this->db->numRows($result)){
		        return $result;
